defmodule Bluetooth.Transport.UART.FramingTest do
  use ExUnit.Case, async: true
  use ExUnitProperties
  alias Bluetooth.Transport.UART.Framing
  alias Bluetooth.Transport.UART.Framing.State

  doctest Bluetooth.Transport.UART.Framing, import: true
